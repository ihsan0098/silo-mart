...
(function(html) {
    ...
    * ------------------------------------------------------ */
    const ssCart = function() {
        ...
        function loadCart() {
            const savedCart = localStorage.getItem('silo-cart');
            if (savedCart) {
        ...
        function saveCart() {
            localStorage.setItem('silo-cart', JSON.stringify(cart));
        }
        ...
        function showNotification(message) {
            ...
            notification.className = 'alert-box alert-box--success';
            notification.innerHTML = `
                ${message}
                <button class="alert-box__close">&times;</button>
            `;
            ...
            setTimeout(() => {
                notification.classList.add('hideit');
                setTimeout(() => {
        ...
        document.addEventListener('click', function(e) {
            ...
            if (e.target.classList.contains('order-now')) {
                ...
                const message = `Halo, saya ingin memesan ${name} dengan harga Rp ${price}.`;
                const whatsappUrl = `https://wa.me/6285272649669?text=${encodeURIComponent(message)}`;
            ...
            // Cart close
            if (e.target.classList.contains('cart-close') || e.target === cartModal) {
